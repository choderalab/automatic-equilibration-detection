...
There is a clear optimal choice at $t_0 \sim 150~\tau$ that minimizes variance while also effectively eliminating bias (where $\tau$ is a natural time unit---see \emph{Simulation Details}).
