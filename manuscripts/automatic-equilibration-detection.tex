...
This method corresponds to a multiscale variant of the initial positive sequence (IPS) method of Geyer, of of the \emph{initial sequence methods}~\cite{geyer-thompson:j-royal-stat-soc-b:1992:initial-sequence-estimators,crc-mcmc-handbook}, in which contributions are accumulated at increasingly longer lag times and the sum of Eq.~\ref{equation:integrated-autocorrelation-time-definition} is truncated when the terms become negative.
