...
# Save plot to PDF.
filename = os.path.join(figure_directory, 'argon-potential.pdf') # PDF file to write
...
#
# FIGURE 1
# Plot average potential decay from initial conditions, along with cumulative average and average with some data discarded to equilibrium.
#
...
#
# TOP PANEL: AVERAGE POTENTIAL AND 95% CONFIDENCE INTERVAL
#
...
pylab.legend(['true expectation', 'cumulative average', r'discarding first %d $\tau$ to equilibration' % Nequil], fontsize=fontsize, frameon=False, loc='lower right')
